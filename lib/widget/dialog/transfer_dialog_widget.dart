...
class TransferDialogWidget extends StatefulWidget {
  ...
  const TransferDialogWidget({Key? key,
    this.amount="0",
    this.contract="--",
    this.coin="--",
    this.from="--",
  ...
  @override
  TransferDialogWidgetState createState() => TransferDialogWidgetState();
}

class TransferDialogWidgetState extends State<TransferDialogWidget> {
