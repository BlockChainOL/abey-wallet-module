...
class TransferTrxDialogWidget extends StatefulWidget {
  ...
  final String from;
  final String to;
  final WalletFeeTrxModel? fee;
  final String? contractAddress;
  final CoinModel? nft;

  const TransferTrxDialogWidget({Key? key,
    this.amount="0",
    this.contract="--",
    this.coin="--",
    this.from="--",
  ...
  @override
  TransferTrxDialogWidgetState createState() => TransferTrxDialogWidgetState();
}

class TransferTrxDialogWidgetState extends State<TransferTrxDialogWidget> {
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          _buildItem(ID.WalletTransferGas.tr, right:widget.fee!.fee! + widget.contract),
        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                Container(
                  padding:SizeUtil.padding(right: 15,left: 0),
