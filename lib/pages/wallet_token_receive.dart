...
class WalletTokenReceivePage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return WalletTokenReceivePageState();
  }
}

class WalletTokenReceivePageState extends State<WalletTokenReceivePage> {
  CoinModel? coinModel;
  ...
  void shareAction() {
    if (coinModel != null && coinModel!.address!.isNotEmptyString()) {
      ShareExtend.share(coinModel!.address!, "text");
    }
  }
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ID.WalletReceiveTip.tr
                            .replaceAll("{##}", coinModel != null && coinModel!.contract!.isNotEmptyString() ? coinModel!.contract! : "##"),
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Text(
                      '${ID.WalletTransferScan.tr} ${coinModel != null && coinModel!.symbol!.isNotEmptyString() ? coinModel!.symbol : ""}',
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: QrImageView(
                            data: coinModel != null && coinModel!.address!.isNotEmptyString() ? coinModel!.address! : "",
                  ...
                  Padding(
                    ...
                    child: Text(
                      "${coinModel != null && coinModel!.address!.isNotEmptyString() ? coinModel!.address : ''}",
