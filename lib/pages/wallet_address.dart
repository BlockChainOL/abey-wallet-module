...
class WalletAddressPage extends StatefulWidget {
  ...
  const WalletAddressPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return WalletAddressPageState();
  }
}

class WalletAddressPageState extends State<WalletAddressPage> {
  ...
  void selectAddress(AddressModel? addressModel) {
    Get.back(result:{"address": addressModel?.address ?? ""},closeOverlays:true);
  }
