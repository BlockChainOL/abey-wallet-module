...
import 'package:r_scan/r_scan_camera.dart';

class CommonScanPage extends StatefulWidget {

  final ValueChanged<String>? callback;

  CommonScanPage({Key? key,@required this.callback}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return new CommonScanPageState();
  }
}
    ...
    if (rScanCameras == null || rScanCameras!.length == 0) {
      return Scaffold(
        body: Container(
          ...
          child: Text(ID.CommonScanTip3.tr),
        ),
      );
    }
        ...
        child: Stack(
          children: <Widget>[
            Container(
              ...
              child: ScanImageView(
                child: AspectRatio(
                  aspectRatio: (controller != null && controller!.value != null ? controller!.value.aspectRatio : 0),
            ...
            Column(
              children: <Widget>[
                ...
                InkWell(
                  ...
                  child:  Image(
                    image: AssetImage(
                        Constant.Assets_Images + "common_scan_light.png"
                    ),
                    width: 48,
                    height: 48,
                  ),
