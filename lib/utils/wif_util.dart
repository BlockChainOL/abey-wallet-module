import "package:abey_wallet/utils/basecheck_util.dart" as basecheck;
...
WIF decode(String string, [int? version]) {
  return decodeRaw(basecheck.decode(string), version);
}

String encode(WIF wif) {
  return basecheck.encode(encodeRaw(wif.version, wif.privateKey, wif.compressed));
}
