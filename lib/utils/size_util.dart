...
class SizeUtil {
  ...
  static margin({double left = 0, double top = 0, double right = 0, double bottom = 0, double all = -1}) {
    if (all > -1) {
      return EdgeInsets.only(left: width(all), right: width(all), top: width(all), bottom: width(all));
    }
    return EdgeInsets.only(left: width(left), right: width(right), top: width(top), bottom: width(bottom));
  }
  ...
  static radius(
      {double topLeft = 0, double topRight = 0, double bottomLeft = 0, double bottomRight = 0, double all = 0}) {
    if (all > 0) {
